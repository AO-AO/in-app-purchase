...
module.exports.refreshGoogleToken = function (configIn, cb) {
	if (cb === undefined && typeof configIn === 'function') {
		cb = configIn;
		configIn = null;
	}
	if (!cb && Promise) {
		return new Promise(function (resolve, reject) {
			module.exports.refreshGoogleToken(configIn, handlePromisedFunctionCb(resolve, reject));
		});
	}
	google.refreshToken(configIn, cb);
